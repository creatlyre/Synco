...
class ShoppingService:
    ...
    def add_multiple(self, calendar_id: str, text: str) -> dict:
        ...
        # ⚡ Bolt Optimization: Pre-fetch sections and overrides once outside the loop
        # Impact: Turns an O(N) query pattern into O(1), preventing N+1 database calls
        # when processing bulk text inputs.
        sections = self.ensure_sections(calendar_id)
    ...
    def _categorize_item(
        ...
        calendar_id: str,
        item_name: str,
        sections: list[ShoppingSection] | None = None,
