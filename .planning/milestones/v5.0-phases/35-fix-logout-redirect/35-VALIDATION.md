...
**Result:** Full re-audit — all 3 requirements have automated tests, all green (3/3 passed in 0.03s). Implementation confirmed: POST→303, GET→302, both redirect to `/auth/login`, cookies cleared. No new gaps.
