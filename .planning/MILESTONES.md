...
## v5.1 E2E Verification & Brand Marketing (Shipped: 2026-03-25)

**Phases completed:** 15 phases (36-50), 13 plans

**Key accomplishments:**

- Playwright E2E test infrastructure with multi-role auth fixtures (free, pro, family-plus) and CI workflow
- 126 E2E tests covering auth, calendar, dashboard, notifications, gating, billing, shopping, sync, and error handling
- Fixed calendar modal JS crash (script ordering in base.html) and pro user subscription gating
- Landing page copy overhaul with benefit-driven messaging, comparison table, founder story, and GitHub badge
...
- Landing UX: mobile hamburger menu, nav Features link, footer GitHub link, contrast fixes
- Pricing tier clarification with benefit-oriented copy, currency i18n, annual toggle
- Version sync to v5.1, SW cache bust, Stripe statement descriptor

**Stats:**

- 121 files changed, 9,252 insertions, 309 deletions
- 60 commits
- 126/126 E2E tests passing, 593 backend tests passing

**Git range:** v5.0 → v5.1

---

## v5.0 Growth & Conversion (Shipped: 2026-03-25)

**Phases completed:** 2 phases (34-35), 2 plans

**Key accomplishments:**

- Hero landing page with social proof trust indicators (open source, GDPR, PWA) and benefit-driven sales copy in PL/EN
- Open Graph and Twitter Card meta tags for social sharing and SEO
- Primary CTA changed from /auth/login to /auth/register for conversion optimization
- Logout redirect fixed — browser redirects to login page instead of raw JSON (303 POST, 302 GET)
- 593 tests passing across all subsystems

**Stats:**

- 215 files changed, 10,367 insertions, 12,298 deletions (includes v4.0 + v5.0 since v3.0 tag)
- Timeline: 2026-03-24 → 2026-03-25 (2 days)
- 145 commits since v3.0 tag
